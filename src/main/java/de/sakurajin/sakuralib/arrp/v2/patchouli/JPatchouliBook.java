 ...
 * For details about the files check out the <a
 * href="https://vazkiimods.github.io/Patchouli/docs/reference/book-json">patchouli
 * documentation</a>
 * @apiNote The default of i18n is true, while the default of patchouli is
 * false. You can disable this with {@link #dontUseI18n()}.
 */
public class JPatchouliBook {
  ...
  public enum TextOverflowMode {
    ...
    TextOverflowMode(String modeString) { this.modeString = modeString; }

    public String toString() { return modeString; }
  }
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#book_texture-string)
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#filler_texture-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#crafting_texture-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#model-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#text_color-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#header_color-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#nameplate_color-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#link_color-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#link_hover_color-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#progress_bar_color-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#progress_bar_background-string)
   * for more information.
   * @param progress_bar_background the progress bar background
   * @return the book itself for method chaining
   */
  public JPatchouliBook
  setProgressBarBackground(String progress_bar_background) {
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#open_sound-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#flip_sound-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#index_icon-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#pamphlet-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#show_progress-boolean)
   * for more information.
   * @return the book itself for method chaining
   */
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#version-string)
   * for more information.
   ...
   * This will be displayed below the book name in the landing page and in the
   * tooltip. Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#subtitle-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#creative_tab-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#advancements_tab-string)
   * for more information.
   ...
   * This automatically sets dont_generate_book to true in order to prevent
   * conflicts. Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#custom_book_item-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#show_toasts-boolean)
   * for more information.
   * @return the book itself for method chaining
   */
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#use_blocky_font-boolean)
   * for more information.
   * @return the book itself for method chaining
   */
   ...
   * Unlike the default of patchouli this class defaults to true so this can be
   * used to disable it. Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#i18n-boolean)
   * for more information.
   * @return the book itself for method chaining
   */
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/patchouli-basics/text-formatting/#custom-macros)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#pause_game-boolean)
   * for more information.
   * @return the book itself for method chaining
   */
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json#text_overflow-string)
   * for more information.
   ...
   * Check out [the patchouli
   * documentation](https://vazkiimods.github.io/Patchouli/docs/reference/book-json)
   * for more information on the format.
   * @apiNote This only adds changes fields to the json object. The default
   * values are not added except for i18n.
   * @apiNote The default of i18n is true, while the default of patchouli is
   * false. You can disable this with {@link #dontUseI18n()}.
  ...
  public JsonObject toJson() {
    ...
    // always set the value of i18n since the default of this class differs from
    // the default of patchouli
    ...
    if (text_color != null)
      bookJson.addProperty("text_color", text_color);
    if (header_color != null)
      bookJson.addProperty("header_color", header_color);
    if (nameplate_color != null)
      bookJson.addProperty("nameplate_color", nameplate_color);
    if (link_color != null)
      bookJson.addProperty("link_color", link_color);
    if (link_hover_color != null)
      bookJson.addProperty("link_hover_color", link_hover_color);
    if (progress_bar_color != null)
      bookJson.addProperty("progress_bar_color", progress_bar_color);
    if (progress_bar_background != null)
      bookJson.addProperty("progress_bar_background", progress_bar_background);
    if (use_blocky_font)
      bookJson.addProperty("use_blocky_font", true);
    if (text_overflow != null)
      bookJson.addProperty("text_overflow", text_overflow.toString());
    if (!show_toasts)
      bookJson.addProperty("show_toasts", false);

    // textures and sounds
    if (book_texture != null)
      bookJson.addProperty("book_texture", book_texture);
    if (filler_texture != null)
      bookJson.addProperty("filler_texture", filler_texture);
    if (crafting_texture != null)
      bookJson.addProperty("crafting_texture", crafting_texture);
    if (model != null)
      bookJson.addProperty("model", model);
    if (index_icon != null)
      bookJson.addProperty("index_icon", index_icon);
    if (custom_book_item != null)
      bookJson.addProperty("custom_book_item", custom_book_item);
    if (open_sound != null)
      bookJson.addProperty("open_sound", open_sound);
    if (flip_sound != null)
      bookJson.addProperty("flip_sound", flip_sound);

    // misc stuff
    if (dont_generate_book)
      bookJson.addProperty("dont_generate_book", true);
    if (pamphlet)
      bookJson.addProperty("pamphlet", true);
    if (!show_progress)
      bookJson.addProperty("show_progress", false);
    if (version != null)
      bookJson.addProperty("version", version);
    if (subtitle != null)
      bookJson.addProperty("subtitle", subtitle);
    if (creative_tab != null)
      bookJson.addProperty("creative_tab", creative_tab);
    if (advancements_tab != null)
      bookJson.addProperty("advancements_tab", advancements_tab);
    if (pause_game)
      bookJson.addProperty("pause_game", true);
   ...
   */
  public String toString() { return SakuraJsonHelper.toPrettyJson(toJson()); }
}
