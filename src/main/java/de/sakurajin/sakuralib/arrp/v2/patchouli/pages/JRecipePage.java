 ...
 */
public class JRecipePage extends JPageBase {
     ...
     * @return The page itself for method chaining.
     */
    public JRecipePage setRecipe2(String item2){
        this.recipe2 = item2;
        return this;
    }
     ...
     * @return The page itself for method chaining.
     */
    public JRecipePage setTitle(String title){
        this.title = title;
        return this;
    }
     ...
     * @return The page itself for method chaining.
     */
    public JRecipePage setText(String text){
        this.text = text;
        return this;
    }
