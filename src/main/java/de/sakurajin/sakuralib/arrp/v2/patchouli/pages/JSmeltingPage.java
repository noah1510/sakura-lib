...
/**
 * A page containing 1 or 2 smelting recipes.
...
public class JSmeltingPage extends JPageBase {
    ...
    protected JSmeltingPage(String item1){
     ...
     */
    public static JSmeltingPage create(String item1){
        return new JSmeltingPage(item1);
    }
     ...
     * @return The page itself for method chaining.
     */
    public JSmeltingPage setRecipe2(String item2){
        this.recipe2 = item2;
        return this;
    }
     ...
     * @return The page itself for method chaining.
     */
    public JSmeltingPage setTitle(String title){
        this.title = title;
        return this;
    }
     ...
     * @return The page itself for method chaining.
     */
    public JSmeltingPage setText(String text){
        this.text = text;
        return this;
    }
